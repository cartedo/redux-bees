...
function buildApi(endpoints) {
  ...
  return Object.keys(endpoints).reduce(function (acc, key) {
    ...
    acc[key] = function () {
      ...
      var req = _request2.default.apply(undefined, _toConsumableArray2(beforeRequest(baseUrl, (0, _applyUrlWithPlaceholders2.default)(path, placeholders), configureOptions(augmentedOptions))));
